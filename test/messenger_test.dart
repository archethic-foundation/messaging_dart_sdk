...
import 'package:archethic_messaging_lib_dart/src/services/messaging_service.dart';
  ...
  group(
    ...
    () {
      test('createNewSCTestnet', () async {
        final apiService =
            archethic.ApiService('https://testnet.archethic.net');
        final keychain = archethic.Keychain(
      ...
      test('updateSC', () async {
        final apiService = archethic.ApiService('http://localhost:4000');
        final keychain = archethic.Keychain(
          seed: archethic.hexToUint8List(
        ...
        final tx = await MessagingService().updateDiscussion(
          ...
          adminKeyPair: archethic.KeyPair(
            privateKey: archethic.hexToUint8List(
              '00002f48b41208d94b5cb07df768f2f4bbc2715731d1490c4cf7e483aad3b0f7a48f',
            ),
            publicKey: archethic.hexToUint8List(
              '0000e94ad258d642d791dfa3f1faffb7d2bb13a898e15677b6997bd95fb127c22668',
            ),
          ),
          discussionSCAddress:
      ...
      test('sendMessageTestnet', () async {
        ...
        await MessagingService().sendMessage(
          ...
          senderKeyPair: archethic.KeyPair(
      ...
      test('readMessagesLocal', () async {
        ...
        await MessagingService().readMessages(
          ...
          discussionSCAddress:
              '000049d1b99645d0168c084983477b0db00e53ac8cc9957ef93bb56777ce0e8d82b1',
          readerKeyPair: archethic.KeyPair(
            privateKey: archethic.hexToUint8List(
              '000001b98027e90c0bd9020aee089a50c84da7185e6258d22d8f1b73c9e56e7f4134',
            ),
            publicKey: archethic.hexToUint8List(
